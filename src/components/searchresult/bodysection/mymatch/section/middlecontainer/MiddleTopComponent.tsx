      ...
      <View style={styles.champContainer}>
        <Image
          ...
          source={{
            uri:
              Platform.OS === 'ios'
                ? `https://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${match.participants.championName}.png`
                : `http://ddragon.leagueoflegends.com/cdn/11.24.1/img/champion/${match.participants.championName}.png`,
          }}
        />
      </View>
